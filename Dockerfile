...
FROM raspbian/raspbian/desktop:latest as base
...
RUN apt-get update
RUN apt-get upgrade
RUN apt-get install git cmake build-essential libusb-1.0-0.dev libtool librtlsdr-dev pkg-config
